...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    ) # LoginRequestSchema | The body contains the refresh token required to obtain a new access token.

    try:
        # Login by obtaining a new access token
        api_response = api_instance.login(login_request_schema)
        pprint(api_response)
...
------------ | ------------- | ------------- | -------------
*AuthApi* | [**login**](docs/apis/tags/AuthApi.md#login) | **post** /login | Login by obtaining a new access token
*EventsApi* | [**send_events**](docs/apis/tags/EventsApi.md#send_events) | **post** /events | Submit a batch of events for ingestion

## Documentation For Models

 - [EventInput](docs/models/EventInput.md)
 - [LoginRequestSchema](docs/models/LoginRequestSchema.md)
 - [LoginResponseSchema](docs/models/LoginResponseSchema.md)
 - [SendEventsRequestSchema](docs/models/SendEventsRequestSchema.md)
